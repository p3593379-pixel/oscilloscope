...
#ifndef BUF_CONNECT_SERVER_TRANSPORT_CONTROL_PLANE_HPP
#define BUF_CONNECT_SERVER_TRANSPORT_CONTROL_PLANE_HPP
...
namespace buf_connect_server::transport {
    ...
    class ControlPlane {
    public:
        explicit ControlPlane(const InterfaceConfig& config);
        ~ControlPlane();
...
#endif  // BUF_CONNECT_SERVER_TRANSPORT_CONTROL_PLANE_HPP