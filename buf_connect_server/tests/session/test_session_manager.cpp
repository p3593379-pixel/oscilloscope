...
SessionManager mgr;
auto mode = mgr.Connect("conn-1", "eng-1", "engineer");
...
SessionManager mgr;
mgr.Connect("conn-1", "eng-1", "engineer");  // ACTIVE
mgr.Connect("conn-2", "eng-2", "engineer");  // OBSERVER
auto result = mgr.ClaimActiveRole("conn-2");
